        ...
        if (!GameLogic.instance.levelFinished) {
            if (InputManager.instance != null) { 
                if (!InputManager.gamePadConnected) {
                    ...
                    /////////////////////////LO DE ARRIBA COMENTADO FUNCIONA/////////////////////
                    /////////////////////////LO DE ARRIBA COMENTADO FUNCIONA/////////////////////
                    switch (InputManager.currentGameMode) {
                        case InputManager.GAMEMODE.SINGLEPLAYER:
                    ...
                    break;
                        case InputManager.GAMEMODE.MULTI_KEYBOARD_CONTROLLER:
                            if (dawn) {
                                if (behav == 0) {
                                    arrowAnchor.transform.position = PJ.transform.position; //se asigna la posicion del personaje a la flecha para que esta siempre aparezca sobre el PJ
                                ...
                                if (behav == 0) {
                                    ...
                                    if ((!dawn && InputManager.instance.dashButton2 && !InputManager.instance.prevDashButton2)) {
                                        Debug.Log("dawn: " + dawn + " dashButton: " + InputManager.instance.dashButton + " dashButton2: " + InputManager.instance.dashButton2);
